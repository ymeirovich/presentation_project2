...
export async function GET(
  ...
  try {
    ...
    console.log('Proxying GET Gap Analysis for workflow:', workflow_id, 'to:', backendUrl)
    ...
    if (!response.ok) {
      console.error('Gap Analysis Dashboard API error:', response.status, data)
    ...
    console.error('Error proxying Gap Analysis Dashboard request:', error)
    return NextResponse.json(
