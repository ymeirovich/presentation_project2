...
Usage:
    python3 -m src.presgen_training --script presgen-training/assets/demo_script.txt --source-video examples/video/presgen_test.mp4
    python3 -m src.presgen_training --script presgen-training/assets/demo_script.txt --quality fast --output presgen-training/outputs/demo_video.mp4
"""
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 -m src.presgen_training --script presgen-training/assets/demo_script.txt
  python3 -m src.presgen_training --script presgen-training/assets/demo_script.txt --quality fast
  python3 -m src.presgen_training --script presgen-training/assets/demo_script.txt --source-video custom_video.mp4
        """
    )
